...
|
*/
$config['botToken'] = "7142736578:AAH4-Y0D2Edi14mgsHFwPmEetnygeCq0FGM";
...
|
*/
$config['db']['hostname'] =  "sql10.freesqldatabase.com";
$config['db']['username'] =  "sql10741496";
$config['db']['password'] =  "73RJxB41Mj";
$config['db']['database'] =  "sql10741496";
